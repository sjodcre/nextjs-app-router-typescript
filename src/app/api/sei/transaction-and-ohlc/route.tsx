  ...
  try {
    ...
    // Calculate market cap if tradesData and nativeTokenPrice are available
      ...
      console.log(marketCap+':'+formattedMarketCap)
        ...
        let result2 = await query(`UPDATE ${transactionTableName} SET sum_native = $1 ,sum_token = $2, tx_status = $3 , timestamp = $4 , token_amount = $5, marketcap = $6 WHERE tx_hash = $7 RETURNING txid` , [sum_native, sum_token, tx_status, time , token_amount,marketCap, tx_hash]);
