...
//   //   `SELECT balance FROM token_balances_ftm WHERE account = $1 AND token_address = $2`,
//   //   [account, tokenAddress]
//   // );

//   const result = await query(
//     `SELECT balance FROM ftm_users_balance WHERE account = $1 AND token_address = $2`,
//     [account, tokenAddress]
//   );
...
//   if (currentBalance === 0) {
//     // await query(
//     //   `INSERT INTO token_balances_ftm (account, token_address, balance) VALUES ($1, $2, $3)`,
//     //   [account, tokenAddress, newBalance]
//     // );
//     await query(
//       `INSERT INTO ftm_users_balance (account, token_address, balance) VALUES ($1, $2, $3)`,
//       [account, tokenAddress, newBalance]
//     );
//   } else {
//     // await query(
//     //   `UPDATE token_balances_ftm SET balance = $1 WHERE account = $2 AND token_address = $3`,
//     //   [newBalance, account, tokenAddress]
//     // );
//     await query(
//       `UPDATE ftm_users_balance SET balance = $1 WHERE account = $2 AND token_address = $3`,
//       [newBalance, account, tokenAddress]
//     );
//   }
// }
