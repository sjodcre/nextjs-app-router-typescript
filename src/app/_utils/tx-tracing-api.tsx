...
//   async function traceTransaction(txId: string): Promise<TraceTransactionResponse> {
  ...
  export async function getTransactionStatus(chainId:string, txHash: string): Promise<{result: ethers.providers.TransactionReceipt, timestamp: number}> {
    let url = ''
    if (chainId === 'ftm'){
